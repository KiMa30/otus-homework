...
test.describe('Sauce shop', () => {
  ...
  test('Blocked user try', async ({ page }) => {
    ...
    const errorLocator = page.locator('(//h3[contains(text(), "Epic sadface: Sorry, this user has been locked out.")])');
  ...
  test('Add an item to the basket', async ({ page }) => {
    ...
    const itemLocator = page.locator('(//div[contains(text(), "Sauce Labs Backpack")])')
